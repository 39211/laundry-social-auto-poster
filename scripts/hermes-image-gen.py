...
experiments. Outputs stamp grok-imagine-image, which the shop owner forbids;
they are not blocked at auto-approve / schedule-ahead / postCurrentSlot
(57 grok-stamped rows published or queued to FB 2026-08-25..09-01). The
source whitelist currently runs only at 06:30 D+3 and generate-missing-images.
