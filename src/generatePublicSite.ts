...
const SUPPORT_PAGE_DEFINITIONS: SupportPageDefinition[] = [
  ...
  },
  {
    ...
    category: "guide",
    title: "窗簾下緣發黑、有味道?台中窗簾清潔｜私享家洗衣店",
    description:
      "私享家洗衣店（台中市西屯區青海路二段365號）處理窗簾清潔：家裡有味道卻找不到來源，十次有八次是窗簾下緣那一折積灰受潮，整片拆下清潔前先傳照片評估。",
    h1: "窗簾下緣發黑、有味道，問題常常在這一折",
    summary:
      "家裡聞起來有味道卻找不到來源，很多時候不是衣服也不是地板，是窗簾下緣那一折。灰塵和濕氣長期積在摺痕裡，表面摸起來是乾的，聞起來卻悶。整片拆下清潔前，先看下緣摺痕和窗簾軌道的狀況。",
    keywords: ["窗簾清潔", "窗簾下緣發霉", "台中窗簾清洗", "窗簾除濕", "台中西屯窗簾送洗", "窗簾異味"],
    service_slug: "fabric-storage",
    local_intent: "台中西屯 窗簾清潔 窗簾下緣發霉",
    content_lastmod: "2026-08-29",
    steps: [
      { name: "先摸下緣那折", text: "窗簾最容易被忽略的不是整片，是最底下靠窗台或地面那一折——灰塵和濕氣最容易積在這裡。" },
      { name: "看有沒有變色", text: "下緣摺痕若已經發黑或有斑點，代表濕氣停留較久，不只是灰塵而已。" },
      { name: "檢查掛勾與軌道", text: "拆下前看掛勾、圈環是否鏽蝕或脆化，避免拆卸時損壞。" },
      { name: "拍照先問", text: "整片窗簾材質、髒污位置與是否有異味，拍照傳 LINE 讓門市先判斷。" }
    ],
    sections: [
      {
        heading: "門市怎麼看窗簾的髒",
        body:
          "家裡聞起來有味道、卻怎麼找都找不到來源，很多時候問題不在衣服也不在地板，是窗簾下緣那一折。窗簾長期垂放，最底下靠窗台或地面的摺痕最容易積灰，加上濕氣不容易散，表面摸起來是乾的，但摺痕裡面悶著。門市會先看材質（棉麻、絲質、遮光布或紗簾各自處理方式不同）、下緣摺痕的髒污和變色程度，以及窗簾軌道與掛勾的狀態，再判斷是整片清潔還是需要特別加強下緣。"
      },
      {
        heading: "什麼救得回、什麼只能維持",
        body:
          "表面灰塵、還沒變色的濕氣痕跡，通常還有清潔空間；下緣已經發黑、長期潮濕造成的霉斑滲入纖維，只能淡化，不保證完全恢復原色。遮光布和特殊塗層材質要先確認洗標，避免破壞塗層或造成分層。窗簾沒有固定價目，因為尺寸、材質與污損程度差異很大，LINE 傳照片（0968327653）先看材質與範圍，才能判斷方向。"
      },
      {
        heading: "送洗前怎麼問窗簾清潔",
        body:
          "整片窗簾清潔前，先傳整體照、下緣摺痕近照、材質標籤（如果還在）與最在意的味道或髒污位置。台中市全區可約免費到府收送，不需要自己拆卸——門市會依現場狀況判斷是否需要協助拆裝。清潔費用依尺寸與材質另計，沒有最低消費門檻。"
      }
    ],
    faqs: [
      {
        question: "窗簾一定要拆下來才能洗嗎？",
        answer: "建議整片拆下清潔比較徹底，尤其是下緣摺痕的部分。不確定怎麼拆可以先傳照片問，或約免費到府收送時一併協助。"
      },
      {
        question: "窗簾下緣發黑還洗得掉嗎？",
        answer: "表面積灰多半能明顯改善；已經滲入纖維的霉斑以淡化為目標，不保證完全恢復原色，會先講清楚再處理。"
      },
      {
        question: "窗簾清潔多少錢？",
        answer: "沒有固定價目，因為尺寸、材質與污損程度差異很大。LINE 傳照片（0968327653）先看範圍，才能抓出方向。"
      },
      {
        question: "台中窗簾清潔可以收送嗎？",
        answer: "可以，台中市全區免費到府收送，沒有最低消費門檻。"
      }
    ]
  }
];
